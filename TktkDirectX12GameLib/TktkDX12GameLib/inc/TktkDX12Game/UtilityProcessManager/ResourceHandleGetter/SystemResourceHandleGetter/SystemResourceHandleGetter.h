...
namespace tktk
{
	...
	public:
		...
		size_t getSystemHandle(SystemPostEffectDrawFuncRunnerType type)	const;
	...
	public:
		...
		void setSystemHandle(SystemPostEffectDrawFuncRunnerType type,	size_t handle);
	...
	private:
		...
		std::unordered_map<SystemPostEffectDrawFuncRunnerType,	size_t>	m_systemPostEffectDrawFuncRunnerHandleMap;
	};
}
