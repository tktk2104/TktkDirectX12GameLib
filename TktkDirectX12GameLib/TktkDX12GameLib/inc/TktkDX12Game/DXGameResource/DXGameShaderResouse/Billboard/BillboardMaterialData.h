...
#include "Structs/BillboardMaterialInstanceData.h"
...
namespace tktk
{
	...
	public:
		...
		void addInstanceParam(const BillboardMaterialInstanceData& instanceParam);
	...
	private:
		...
		// インスタンス情報のリスト
		std::forward_list<BillboardMaterialInstanceData>	m_instanceParamList;
	};
}
