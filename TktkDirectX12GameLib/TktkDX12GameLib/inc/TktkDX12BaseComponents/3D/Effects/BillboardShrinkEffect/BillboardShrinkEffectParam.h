#ifndef BILLBOARD_SHRINK_EFFECT_PARAM_H_
#define BILLBOARD_SHRINK_EFFECT_PARAM_H_
...
namespace tktk
{
	struct BillboardShrinkEffectParam
	{
		//************************************************************
		/* 生成情報 */

		// 収縮点座標
		tktkMath::Vector3 shrinkTargetPos				{ tktkMath::Vector3_v::zero };
		// 収縮点座標のぶれ
		tktkMath::Vector3 shrinkTargetPosRandomRange	{ tktkMath::Vector3_v::zero };
...
#endif // !BILLBOARD_SHRINK_EFFECT_PARAM_H_