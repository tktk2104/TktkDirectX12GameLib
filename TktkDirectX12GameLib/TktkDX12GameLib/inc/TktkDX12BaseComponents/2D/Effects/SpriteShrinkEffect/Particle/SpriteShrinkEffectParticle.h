...
namespace tktk
{
	...
	public:
		...
		SpriteShrinkEffectParticle(const ComponentPtr<SpriteDrawer>& targetDrawer, float moveSpeed, const tktkMath::Vector2& scalingSize, const tktkMath::Color& blendRateChangeWidth, float lifeTimeSec);
