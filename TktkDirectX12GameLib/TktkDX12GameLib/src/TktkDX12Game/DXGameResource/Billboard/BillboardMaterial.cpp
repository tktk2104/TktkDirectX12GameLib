...
namespace tktk
{
	...
	size_t BillboardMaterial::create(const BillboardMaterialInitParam& initParam)
	{
		return m_billboardMaterialArray.create(initParam);
	}

	void BillboardMaterial::drawBillboard(size_t handle, const BillboardDrawFuncBaseArgs& drawFuncArgs) const
	{
		m_billboardMaterialArray.getMatchHandlePtr(handle)->drawBillboard(drawFuncArgs);
	}

	void BillboardMaterial::updateTransformCbuffer(size_t handle, size_t copyBufferHandle, const BillboardCbufferUpdateFuncArgs& updateArgs) const
	{
		m_billboardMaterialArray.getMatchHandlePtr(handle)->updateTransformCbuffer(copyBufferHandle, updateArgs);
	}

	void BillboardMaterial::updateTransformCbufferUseClippingParam(size_t handle, size_t copyBufferHandle, const BillboardCbufferUpdateFuncArgs& updateArgs, const BillboardClippingParam& clippingParam) const
	{
