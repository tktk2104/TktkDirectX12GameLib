#include "TktkDX12Game/DXGameResource/GameObjectResouse/Component/DefaultComponents/StateMachine/Structs/StateMachineListInitParam.h"
...
namespace tktk
{
	...
	void StateMachineListInitParam::addChildNode(StateTypeHierarchy hierarchy, StateTypeList child)
	{
		...
		// 現在のステートを表すポインタが不正だったらここで処理を終える
		if (curNodePtr == nullptr) return;
