...
namespace tktk
{
	...
	size_t Line2DMaterial::create()
	{
		return m_line2DMaterialArray.create();
	}

	void Line2DMaterial::erase(size_t handle)
	{
		m_line2DMaterialArray.erase(handle);
	}

	void Line2DMaterial::drawLine(size_t handle, const Line2DMaterialDrawFuncArgs& drawFuncArgs)
	{
