#ifndef ACT_3D_RESULT_SCENE_CHANGER_SCRIPT_H_
#define ACT_3D_RESULT_SCENE_CHANGER_SCRIPT_H_
...
public:
	...
	Act3D_ResultSceneChangerScript() = default;
...
#endif // !ACT_3D_RESULT_SCENE_CHANGER_SCRIPT_H_
