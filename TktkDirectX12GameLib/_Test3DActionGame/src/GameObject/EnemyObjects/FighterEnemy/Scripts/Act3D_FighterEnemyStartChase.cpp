#include "Act3D_FighterEnemyStartChase.h"

#include <stdexcept>
#include <TktkMath/MathHelper.h>
#include "../../../../Enums/Enums.h"

void Act3D_FighterEnemyStartChase::start()
{
...
void Act3D_FighterEnemyStartChase::update()
{
	...
	{
		getGameObject()->stateEnable(FighterEnemyState::Move);
		getGameObject()->stateEnable(FighterEnemyState::Walk);
